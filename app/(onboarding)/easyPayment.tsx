...
const easyPayment = () => {
  ...
  return (
    <SafeAreaView className='flex-1 bg-yellowBase pt-10'>
      <ImageBackground source={images.easyPaymentBackground} className='flex-1 justify-between items-center'>
        ...
        <View className='w-full max-h-[338px] bg-white flex justify-center items-center rounded-2xl'>
          <View className='size-full flex items-center justify-around'>
            <View className='items-center gap-5'>
              <Image source={images.easyPaymentIcon} resizeMode='contain' accessibilityLabel="Order food icon"/>
              <Text className='font-black text-3xl text-orangeBase text-center'>Easy Payment</Text>
              ...
              <View className='mb-10 mt-5 gap-10'>
                ...
                <Pressable className="bg-orangeBase rounded-full px-14 py-2" accessibilityLabel="Next step button"
                  onPress={()=>router.push('/faseDelivery')}  
                >
